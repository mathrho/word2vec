time ./word2vec -train ../yfcc100m_lower_nonumbers -output yahoo_100m_words_50d.output -cbow 0 -size 50 -window 8 -negative 25 -hs 0 -sample 1e-4 -threads 40 -binary 0 -iter 5
